...
# 🎯 WITHDRAWAL DESTINATION CHANNEL (Changed to your public handle!)
...
def save_wallet_or_promo(message):
    ...
    if input_text.lower() == "muiz":
        ...
        text, markup = render_dashboard_ui(user_id)
        bot.send_message(user_id, f"🎉 *PROMO CODE APPLIED!*\n━━━━━━━━━━━━━━━━━━━━━━━━\nCode `muiz` verified successfully. *+${PROMO_REWARD:.2f} USD* has been added to your balance!", reply_markup=markup, reply_markup=markup, parse_mode="Markdown")
        return
