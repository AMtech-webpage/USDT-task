...
def process_ui_interactions(call):
    ...
    if call.data == "ui_verify_gate":
        if check_tg_membership(user_id):
            ...
            if status and status[1] == 0:
                ...
                if referrer:
                    ...
                    try:
                        alert_msg = "🚀 *REFERRAL MILESTONE SUCCESSFUL*\n━━━━━━━━━━━━━━━━━━━━━━━━\nAn onboarded link partner has verified! *+$" + f"{REFERRAL_REWARD:.2f}" + " USD* added to your balance."
        ...
        task_init_text = "📋 *NEW REWARD TASK FOUND!*\n━━━━━━━━━━━━━━━━━━━━━━━━\n💰 Reward Value: *$" + f"{TASK_REWARD:.2f}" + " USD*\nTask Type: YouTube Watch & Subscribe\n\nTap the button below to initialize your secure connection."
        bot.send_message(user_id, task_init_text, reply_markup=step1_markup, parse_mode="Markdown")
        ...
        task_run_text = "🎬 *TASK PROCESSING STARTED*\n━━━━━━━━━━━━━━━━━━━━━━━━\n1. Click the **Open Video Link** button below.\n2. Watch the video fully for **at least 15 seconds**.\n3. Make sure to **Subscribe** to the channel.\n4. Return here and click **Verify Video Task Completed** to claim rewards."
        bot.send_message(user_id, task_run_text, reply_markup=task_markup, parse_mode="Markdown")
        ...
        if elapsed_time < 15.0:
            ...
            try: 
                bot.answer_callback_query(call.id, "⚠️ Access Denied: Watch for 15 seconds! (" + str(remaining) + "s remaining)", show_alert=True)
            except Exception: 
                pass
            return
        ...
        try: bot.answer_callback_query(call.id, "🎉 Success! +$" + f"{TASK_REWARD:.2f}" + " USD added.", show_alert=True)
        except Exception: pass
        
        text, markup = render_dashboard_ui(user_id)
        bot.send_message(user_id, "✅ *TASK CREDITED SUCCESSFULLY*\n━━━━━━━━━━━━━━━━━━━━━━━━\nWatch metrics verified! *+$" + f"{TASK_REWARD:.2f}" + " USD* added to your balance. Make sure you stay subscribed!", parse_mode="Markdown")
        bot.send_message(user_id, text, reply_markup=markup, parse_mode="Markdown")
